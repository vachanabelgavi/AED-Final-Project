...
public class PharmacyAdminJPanel extends javax.swing.JPanel {
     ...
     */
    public PharmacyAdminJPanel(Ecosystem system, UserAccount ua, Network network, Organization organization, Enterprise enterprise) {
        initComponents();
    ...
    private void btnSendPrescriptionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSendPrescriptionActionPerformed
        ...
        UserAccount doctorUser = this.enterprise.getOrganizationDirectory().getOrganizationByName("Doctor").getUserAccountDirectory().findUser("nidhi");
